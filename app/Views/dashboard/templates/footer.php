<div class="footTecn">
        <p class="mbr-text" style="color:#fff">
            ...
            <br>
            <br>Av. Universidad 1200, Col. Xoco, Ciudad de México, Alcaldía Benito Juárez C.P. 03330<br>
            <br>
            <br><strong>Contacto</strong>&nbsp;<br>
            <br>Email: contacto@tecnm.mx&nbsp;<br>Conmutador: 55 36002500 <br>
        </p>
        <p class="mbr-text"><strong>Enlaces</strong><br>
            ...
            <br>
            <br><strong> Número de visitas: </strong>3,173,349					
        </p>
		<a href="?vista=Ubicacion" title="Ver Ubicación">
			<img loading="lazy" src="img/Foto_Ubicación.jpg" alt="Ubicación" style="width:100%;">
		</a>
        ...
        <div class="copyR">
            <div class="col-sm-6 copyright">
                ...
                <p class="mbr-text mbr-fonts-style display-7">
                    © Copyright 2022  TecNM - Todos los Derechos Reservados
                </p>
                <br>
                <p class="mbr-text mbr-fonts-style display-7">
                    <a href="https://www.gob.mx/cms/uploads/attachment/file/328462/Proyecto_Aviso_Privacidad_TecNM_16052018.pdf" target="_blank" style="text-decoration:none; color:#fff;">
                ...
                <p class="mbr-text mbr-fonts-style display-7">
                    ...
                    <script>
                        let now = new Date();
                        document.write(now.getDate() + " / "+(now.getUTCMonth()+1)+ " / "+now.getFullYear());
                    </script>
                </p>
                </center>
            </div>
    ...
    <div class="fG5" style="height: 5vh;">
        <br>
    </div> 

    <div class="footGob">
        <div class="fG1">
            <img src="img/1.png" alt="" style="height: 70px; ">
        </div>
        <div class="fG2">
            <h5>Enlaces</h5>
            <ul>
                ...
                <li>
                    <a href="">Publicaciones Oficiales</a>
                </li>
                <li>
                    <a href="">Marco Jurídico</a>
                </li>
                <li>
                    <a href="">Plataforma Nacional de Transparencia</a>
                </li>
            </ul>
        </div>
        <div class="fG3">
